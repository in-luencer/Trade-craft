...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    // For demo purposes, we'll consider these routes as authenticated
    ...
    // For demo purposes, we'll consider login and signup as non-authenticated
    const isAuthPage = pathname === "/login" || pathname === "/signup"

    // If we're on an authenticated route but not on login/signup, consider the user authenticated
