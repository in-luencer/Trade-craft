...
import type { StrategyConfig } from "./strategy-builder" // Changed from Strategy to StrategyConfig
import { generatePineScript } from "./pine-script-generator"
import { generatePseudocode } from "./pseudocode-generator"

interface StrategyPreviewProps {
  strategy: StrategyConfig // Changed from Strategy to StrategyConfig
}
      ...
      <Card>
        ...
        <CardContent>
          <Tabs defaultValue="pine">
            <TabsList>
              <TabsTrigger value="pine">Pine ScriptS</TabsTrigger>
